 ...
 * @author Win 10
 */
public class GenerateLecturer extends javax.swing.JFrame {
Connection conn=null;
    PreparedStatement pst=null;
    ResultSet rs=null;
    /**
    /**
     * Creates new form GenerateLecturer
     */
    ...
    private void initComponents() {
        ...
        lecturer.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Lecturer" }));
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGap(42, 42, 42)
                .addComponent(lecturer, javax.swing.GroupLayout.PREFERRED_SIZE, 214, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(lecturer, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        String lectuer=lecturer.getSelectedItem().toString();
        
        try{
            
            String sql="Select s.groupID,s.lecturer1, n.day, n.NA_from, n.NA_to, s.subject, s.tag, s.room from  not_available_time_lecturers n, sessionwithrooms s WHERE n.lecturer='"+lectuer+"' AND n.session=s.sessionID group by sessionID";
            pst=conn.prepareStatement(sql);
            rs=pst.executeQuery();
...
Logger.getLogger(GenerateLecturer.class.getName()).log(Level.SEVERE, null, ex);
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GenerateLecturer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GenerateLecturer().setVisible(true);
            }
        });
    }
