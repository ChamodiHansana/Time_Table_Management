 ...
 */
public class ParrallelView extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ParrallelView
     */
    public ParrallelView() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ParrallelView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ParrallelView().setVisible(true);
            }
        });
    }
